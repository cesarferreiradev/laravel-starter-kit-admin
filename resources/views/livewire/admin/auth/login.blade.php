                    ...
                    <form class="space-y-6" wire:submit="authenticate">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input type="email" wire:model="email" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 rounded-lg outline-blue-600" placeholder="Insira seu email" />
                        ...
                        <div>
                            <label class="text-slate-900 text-sm font-medium mb-2 block">Senha</label>
                            <div class="relative flex items-center">
                                <input type="password" wire:model="password" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 rounded-lg outline-blue-600" placeholder="Insira sua senha" />
